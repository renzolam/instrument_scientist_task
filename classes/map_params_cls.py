...
class MapParams:
    ...
    def __init__(self):
        ...
        if not (0 < self.lat_bin_size_degree < 90):
            ...
            raise ValueError(f'Latitude bin size {self.lat_bin_size_degree} must be divisible than 90 degrees'
        ...
        if not (0 < self.mlt_bin_size_hr < 24):
            ...
            raise ValueError(f'MLT bin size {self.mlt_bin_size_hr} must be divisible than 24'
